...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['event_slug']) && !empty($_POST['event_slug'])) {
        ...
        } elseif (!isSlugUnique($slug, $eventId)) {
            $errors[] = 'Slug bereits vergeben';
        }
    } else {
        $slug = $event['event_slug']; // Keep existing slug
    }
        ...
        try {
            ...
            $stmt = $conn->prepare("
                ...
                SET name = ?, latitude = ?, longitude = ?, radius_meters = ?, 
                    ...
                    show_logo = ?, show_display_link = ?, show_gallery_link = ?, event_slug = ?, updated_at = CURRENT_TIMESTAMP
                WHERE id = ?
            ");
            ...
            $stmt->execute([
                ...
                $finalLogoFilename, $showLogo, $showDisplayLink, $showGalleryLink, $slug, $eventId
            ]);
                ...
                <form method="POST" class="event-form" enctype="multipart/form-data">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <small>Bestimmt die URL: picturewall/SLUG</small>
                        </div>
