...
class PhotoWallDisplay {
    ...
    async init() {
        console.log('PhotoWallDisplay init started');
        ...
        console.log('PhotoWallDisplay init completed');
    }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.body.classList.contains('display-mode')) {
        console.log('Initializing PhotoWallDisplay...');
        window.photoWallDisplay = new PhotoWallDisplay();
    } else {
...
document.addEventListener('visibilitychange', () => {
    if (window.photoWallDisplay) {
        if (document.hidden) {
            window.photoWallDisplay.pause();
        } else {
            window.photoWallDisplay.play();
        }
    }
});
...
window.addEventListener('resize', () => {
    if (window.photoWallDisplay) {
        ...
        window.photoWallDisplay.renderPhotos();
    }
});
