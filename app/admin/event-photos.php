                                ...
                                <div class="photo-info">
                                    ...
                                    <div class="photo-actions">
                                        <div class="rotation-controls">
                                            <button type="button" 
                                                    class="btn btn-sm btn-rotate rotate-left"
                                            ...
                                            <button type="button" 
                                                    class="btn btn-sm btn-rotate rotate-180"
                                                    data-photo-id="<?php echo $photo['id']; ?>"
                                                    data-angle="180"
                                                    title="180° drehen">
                                                ↻
                                            ...
                                            <button type="button" 
                                                    class="btn btn-sm btn-rotate rotate-right"
                                                    data-photo-id="<?php echo $photo['id']; ?>"
                                                    data-angle="90"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            rotateButtons.forEach(button => {
                button.addEventListener('click', function(e) {
                    ...
                    // Disable all rotation buttons for this photo during request
                    const photoCard = this.closest('.photo-card');
                    const allRotateButtons = photoCard.querySelectorAll('.btn-rotate');
                    allRotateButtons.forEach(btn => btn.disabled = true);
                    ...
                    .then(response => {
                        ...
                        return response.text().then(text => {
                            console.log('Rotation response text:', text);
                            try {
                    ...
                    .then(data => {
                        console.log('Rotation parsed data:', data);
                        if (data.success) {
                            console.log('Rotation success: Updating UI for photo ID', photoId);
                            
                            // Update the image preview
                            const img = photoCard.querySelector('.photo-preview img');
                            if (img) {
                            ...
                            showMessage(data.error || 'Fehler beim Rotieren', 'error');
                        }
                    })
                    .catch(error => {
                    ...
                    .finally(() => {
                        // Re-enable all rotation buttons
                        allRotateButtons.forEach(btn => btn.disabled = false);
