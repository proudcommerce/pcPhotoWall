...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $displayInterval = (int)($_POST['display_interval'] ?? DEFAULT_DISPLAY_INTERVAL);
    $maxUploadSize = (int)($_POST['max_upload_size'] ?? DEFAULT_MAX_UPLOAD_SIZE);
            ...
            <form method="POST" class="event-form" enctype="multipart/form-data">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <small>Wird automatisch generiert wenn leer. Bestimmt die URL: photowall/SLUG</small>
                    </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="radius_meters" name="radius_meters" min="10" max="10000" required
                               value="<?php echo htmlspecialchars($_POST['radius_meters'] ?? GPS_DEFAULT_RADIUS_METERS); ?>">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select id="display_count" name="display_count">
                                <option value="1" <?php echo ($_POST['display_count'] ?? DEFAULT_DISPLAY_COUNT) == 1 ? 'selected' : ''; ?>>1 Foto</option>
                                <option value="2" <?php echo ($_POST['display_count'] ?? DEFAULT_DISPLAY_COUNT) == 2 ? 'selected' : ''; ?>>2 Fotos</option>
                                <option value="3" <?php echo ($_POST['display_count'] ?? DEFAULT_DISPLAY_COUNT) == 3 ? 'selected' : ''; ?>>3 Fotos</option>
                                <option value="4" <?php echo ($_POST['display_count'] ?? DEFAULT_DISPLAY_COUNT) == 4 ? 'selected' : ''; ?>>4 Fotos</option>
                                <option value="6" <?php echo ($_POST['display_count'] ?? DEFAULT_DISPLAY_COUNT) == 6 ? 'selected' : ''; ?>>6 Fotos</option>
                                <option value="8" <?php echo ($_POST['display_count'] ?? DEFAULT_DISPLAY_COUNT) == 8 ? 'selected' : ''; ?>>8 Fotos</option>
                                <option value="10" <?php echo ($_POST['display_count'] ?? DEFAULT_DISPLAY_COUNT) == 10 ? 'selected' : ''; ?>>10 Fotos</option>
                            </select>
                    ...
                    <div class="form-group">
                        <label>
                            <input type="checkbox" name="show_qr_code" value="1" 
                                   <?php echo isset($_POST['show_qr_code']) ? 'checked' : ''; ?>>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        <label>
                            <input type="checkbox" name="upload_enabled" value="1"
                                   <?php echo isset($_POST['upload_enabled']) ? 'checked' : 'checked'; ?>>
                            Upload aktiviert
                        </label>
                    ...
                    <div class="form-group">
                        ...
                        <select id="max_upload_size" name="max_upload_size">
                            <option value="1048576" <?php echo ($_POST['max_upload_size'] ?? DEFAULT_MAX_UPLOAD_SIZE) == 1048576 ? 'selected' : ''; ?>>1 MB</option>
                            <option value="2097152" <?php echo ($_POST['max_upload_size'] ?? DEFAULT_MAX_UPLOAD_SIZE) == 2097152 ? 'selected' : ''; ?>>2 MB</option>
                            <option value="5242880" <?php echo ($_POST['max_upload_size'] ?? DEFAULT_MAX_UPLOAD_SIZE) == 5242880 ? 'selected' : ''; ?>>5 MB</option>
                            <option value="10485760" <?php echo ($_POST['max_upload_size'] ?? DEFAULT_MAX_UPLOAD_SIZE) == 10485760 ? 'selected' : ''; ?>>10 MB</option>
                            <option value="20971520" <?php echo ($_POST['max_upload_size'] ?? DEFAULT_MAX_UPLOAD_SIZE) == 20971520 ? 'selected' : ''; ?>>20 MB</option>
                            <option value="52428800" <?php echo ($_POST['max_upload_size'] ?? DEFAULT_MAX_UPLOAD_SIZE) == 52428800 ? 'selected' : ''; ?>>50 MB</option>
                        </select>
